        ...
        foreach ($data as $productSizeColor) { 
            ...
            echo "
                <tr>
                    ...
                    <td class='manage-productSizeColor-action'>
                        <a href='./index.php?page=update-productSizeColor&id=".$productData[0]->getId()."'>
                            <button class='edit action-btn' data-toggle='modal' data-target='#editModal'>
                                Sửa
                            </button>
                        </a>
                        <a href='./index.php?page=manage-productSizeColor&action=delete&id=".$productData[0]->getId()."'>
